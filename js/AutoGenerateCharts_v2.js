...
function DrawCharts(district) {
    ...
    var json1 = d3.csv("data/mdc_v2.csv", function(d) {
        ...
        var barChartData = {
            labels: ["Less than $10,000", "$10,000 to $14,999", "$15,000 to $24,999", "$25,000 to $34,999", "$35,000 to $49,999", "$50,000 to $74,999", "$75,000 to $99,999", "$100,000 to $149,999", "$150,000 to $199,999", "$200,000 or more"],
            datasets: [{
        ...
        // window.myBar6 = new Chart(document.getElementById("canvas2").getContext("2d")).Pie(barChartData2);
        //statistics
        //  total pop | austin pop,
        //  total housing units | austin hu

        // window.myBar7 = new Chart(document.getElementById("canvas2").getContext("2d")).Pie(barChartData2); //population distribution
