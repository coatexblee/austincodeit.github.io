$(document).ready(function(){let createFinalPDF=function(){console.log(global_pdf);let $directionsText=$('#directions-panel')[0];let pdfOptions={orientation:"portrait",unit:"mm",format:"letter"};let pdf=new jsPDF(pdfOptions);pdf.setFont("helvetica");pdf.setTextColor(0,0,0);pdf.setLineWidth(0.5);let left_margin=16;let page_height=280;let page_width=200;let content_margin=40;let page_count=1;let labels='ABCDEFGHIJKLMNOPQRSTUVWXYZ';let getRightMargin=function(obj){return page_width-(obj.length*2);}
...
let mapHeight=400
let google_1="https://maps.googleapis.com/maps/api/staticmap";let google_2="?center="+global_pdf.map_center;let google_3="&zoom="+global_pdf.map_zoom;let google_4="&size=640x400";let google_5=createMarkerArray(global_pdf.route_stops);let google_6="&path=weight:4%7Ccolor:blue%7Cenc:"+global_pdf.route_path;let google_k="&key=AIzaSyCSjAnT5cJ03MwURghAT1nZrLz4InNRpP0";let pdfImgWidth=mapWidth*(184/mapWidth);let pdfImgHeight=mapHeight*(105/mapHeight);let picMarginX=10+page_width/2;let picMarginY=content_margin-10;console.log(google_1+google_2+google_3+google_4+google_5+google_6+"&maptype=roadmap"+google_k);function addGoogleMapImage(){let $canvas=document.getElementById("canvasImg")
